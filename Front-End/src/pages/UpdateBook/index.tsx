...
const UpdateBook = () => {
  ...
  return (
    <BaseForm onSubmit={handleSubmit}>
      ...
      <CoverSelect image={cover} onCoverChange={() => handleCoverChange}/>
