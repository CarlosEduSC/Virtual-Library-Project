  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <h1>Atualizar Livro</h1>
	        ...
	        <form className="row g-3 needs-validation" method="post" action="find-book" >
				<div className="col-md-4">
					<label  className="form-label">Digite o Id do livro que deseja alterar:</label>
					<input type="text" className="form-control" id="idLivro" name="id-livro" required/>
				</div>
				
				<div className="col-12">
					<button className="btn btn-primary" type="submit">Buscar Livro</button>
				</div>
			</form>
    </div>
  )
