const UpdateLivro = () => {
    return (
		...
		<form className="row g-3 needs-validation" method="post" action="update-livro" >
			<div className="col-md-4">
				<label  className="form-label">Nome:</label>
				<input type="text" className="form-control" id="nomeLivro" name="nome-livro" value="<%= l.getNomeLivro() %>" required/>
			</div>
			
			<div className="col-md-4">
				<label  className="form-label">Email:</label>
				<input type="" className="form-control" id="autorLivro" name="autor-livro" value="<%= l.getAutor() %>" required/>
			</div>
			...
			<div className="col-12">
				<button className="btn btn-primary" type="submit">Atualizar livro</button>
			</div>
		</form>
        </div>
    )
