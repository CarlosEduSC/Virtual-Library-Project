const CadastroUsuario = () => {
	return (
		<>
			...
			<form className="row g-3 needs-validation" method="post" action="cadastro-usuario">
				<div className="col-md-4">
					<label className="form-label">Nome:</label>
					<input type="text" className="form-control" id="nomeUsuario" name="nome-usuario" required />
				</div>

				<div className="col-md-4">
					<label className="form-label">Email:</label>
					<input type="email" className="form-control" id="emailUsuario" name="email-usuario" required />
				</div>

				<div className="col-md-6">
					<label className="form-label">Senha:</label>
					<input type="password" className="form-control" id="senhaUsuario" name="senha-usuario" required />
				</div>
				...
				<div className="col-12">
					<button className="btn btn-primary" type="submit">Cadastrar usuario</button>
				</div>
			</form>
